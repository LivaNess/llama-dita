...
| :--- | :--- | :--- | :--- |
| Claude | `1.14.1A` → `1.14.2A` | `src/social/panel.js`, `src/social/social.css`, `index.html`, `src/style.css`, `src/network/peerManager.js`, `src/main.js` | Botón de llamar con ícono verde + botón para salir de la llamada |
